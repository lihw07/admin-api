...
type ISysRoleService interface {
	CreateSysRole(c *gin.Context, dto model.AddSysRoleDto)
	GetSysRoleById(c *gin.Context, Id int)
	UpdateSysRole(c *gin.Context, dto model.UpdateSysRoleDto)
	DeleteSysRoleById(c *gin.Context, dto model.SysRoleIdDto)
	UpdateSysRoleStatus(c *gin.Context, dto model.UpdateSysRoleStatusDto)
	...
	AssignPermissions(c *gin.Context, menu model.RoleMenu)
}
